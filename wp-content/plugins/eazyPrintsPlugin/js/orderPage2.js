...
const sizefinish = document.getElementById("userdata_1_field_1");
const printQty = document.getElementById("userdata_1_field_2");
const reSize = document.getElementById("userdata_1_field_3");
const eachPrice = document.getElementById("userdata_1_field_4");
const printPrice = document.getElementById("userdata_1_field_5");
const size = document.getElementById("userdata_1_field_6");
const finish = document.getElementById("userdata_1_field_7");
   ...
   //  const totalCost = document.getElementById("acf-field_6385721dce4e6-field_6385716f32de1");
    ...
    export function getOrderSize(event) {
     ...
     //  console.log("qty " + qty);
      ...
      // Print cost 
     //  var print_cost = acf.getField('field_6385711932dde');
     //  // var printCostValue = acf.getField('field_6385711932dde').val();
     //  print_cost.val(totalPrintsCost2.toFixed(2));
      ...
      // print_cost.val(totalPrintsCost2.toFixed(2));
       ...
       // let gstCost = (totalPrintsCost2)  * 0.15;
       // var gst_cost = acf.getField('field_6385714132de0');
       // gst_cost.val(gstCost.toFixed(2));

       // // Total costs
       // let totalCost = totalPrintsCost2 + gstCost ;
       // var total_cost = acf.getField('field_6385716f32de1');
    ...
    export function UpdateOrderTotals2() {
       ...
       // const gstCost2 = document.getElementById("acf-field_6389b2b702e18-field_6385714132de0");
       // console.log("222 gst: ", gstCost2);
      // let pc = printPrice2.value;
       // console.log("printCost: ", Number(pc).toFixed(2));
      // updateNumberWFUField(printPrice2, pc);




      // var varl = acf.getField('field_631b1b47a4244').val();
      // console.log("vall: ", varl);
      // let var2 = 234;
      // acf.set('field_631b1b47a4244', 123432 );
      // console.log("val2l: ", var2);
      ...
      // let total = Number(4.50);
      // total = (Number(total)).toFixed(2);
      // // deliveryCost2.value = total;
      // // Get GST
      // let gstCost = (Number(total) + Number(pc)) * 0.15;
      // gstCost = gstCost.toFixed(2);
      // console.log("ccc gst: ", gstCost2.id, gstCost);
      // updateNumberWFUField(gstCost2.id, gstCost);
      // let cost = (Number(total) + Number(pc)) + Number(gstCost2);
      // // console.log("Cost: ", cost.toFixed(2));
      // updateNumberWFUField(totalCost2, cost);
