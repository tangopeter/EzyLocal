...
function wfu_attribute_definitions() {
	$defs = array(
		...
		array(
			...
			"mode"		=> "free",
			"category"	=> "themes",
			"subcategory"	=> "Material UI Settings",
			"parent"	=> "",
			"dependencies"	=> array( "muiprimarycolor", "muisecondarycolor", "muierrorcolor", "muioverridecssmethod" ),
			"variables"	=> null,
			"help"		=> "If enabled the upload form will use Material UI components. Default is false."
		),
		array(
			"name"		=> "Material UI Primary Color",
			...
			"dependencies"	=> null,
			"variables"	=> null,
			"help"		=> "The Material UI theme primary color."
		),
		array(
			"name"		=> "Material UI Text Color",
			...
			"dependencies"	=> null,
			"variables"	=> null,
			"help"		=> "The Material UI theme text primary color."
		),
		array(
			"name"		=> "Material UI Error Color",
			...
			"dependencies"	=> null,
			"variables"	=> null,
			"help"		=> "The Material UI theme error color."
		),
		array(
			...
			"dependencies"	=> null,
			"variables"	=> null,
			"help"		=> "If enabled Material UI will turn to dark theme."
		),
		array(
			"name"		=> "Override CSS Method",
			"attribute"	=> "muioverridecssmethod",
			"type"		=> "hidden",
			"validator"	=> "listitem",
			"listitems"	=> array("strongstyles-selected", "strongstyles-all", "layers", "shadow-dom"),
			...
			"dependencies"	=> null,
			"variables"	=> null,
			"help"		=> "The Material UI components require specific CSS. However the theme's and other loaded styles may override them, causing the components not to show correctly. The plugin uses some methods to override the loaded styles. The first method, 'strongstyles-selected', makes the CSS selectors of some Material UI styles more specific. The second method, 'strongstyles-all', makes the CSS selectors of all Material UI styles more specific. The third method, 'layers' uses CSS cascading layers to increase the precendence of Material UI styles. The fourth method puts all Material UI components and their styles in Shadow DOM."
		),
		array(
